---
title: Themes
description: "Zen supports light and dark themes out of the box."
---

import { DataColumn, DataTable, Example, PaletteSwatchesExample, ThemeButton, ThemeButtonExample } from '../../../mdx-components';
...
function LocalThemeExample() {
  ...
  return (
    <Box ref={containerRef} padding="6" backgroundColor="surface">
...
<Example>
  <DataTable
    data={[
      { name: '--zen-surface', description: 'Primary background color' },
      { name: '--zen-surface-raised', description: 'Elevated surface background' },
      { name: '--zen-surface-sunken', description: 'Recessed surface background' },
      { name: '--zen-surface-overlay', description: 'Overlay/modal background' },
      { name: '--zen-fg', description: 'Primary text color' },
      { name: '--zen-fg-muted', description: 'Muted/subtle text color' },
      { name: '--zen-border', description: 'Default border color' },
      { name: '--zen-border-strong', description: 'Emphasized border color' },
      { name: '--zen-interactive-bg', description: 'Interactive element background' },
      { name: '--zen-primary', description: 'Primary/accent color' },
    ]}
  >

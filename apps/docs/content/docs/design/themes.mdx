...
<Example>
  <DataTable
    data={[
      { name: '--zen-surface-base', description: 'Primary background color' },
      ...
      { name: '--zen-text-primary', description: 'Primary text color' },
      { name: '--zen-text-muted', description: 'Muted/subtle text color' },
      { name: '--zen-border-default', description: 'Default border color' },

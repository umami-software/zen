---
title: Usage Guide
description: "This guide covers the core components and conventions used to build interfaces with Zen."
---

import { Box, Button, Column, Example, Grid, Heading, Lucide, Row, Text, TextField } from '../../mdx-components';
...
| [Row](/docs/layout/flexbox) | Horizontal flex layout |
| [Column](/docs/layout/flexbox) | Vertical flex layout |
...
```jsx
<Box padding="6" border borderRadius="lg" shadow="sm" backgroundColor="surface">
  <Column gap="4">
...
<Example>
  <Box padding="6" border borderRadius="lg" shadow="sm" backgroundColor="surface" maxWidth="300px">
    <Column gap="4">
      <Heading size="lg">Card Title</Heading>
      <Text color="muted">Card description or content goes here.</Text>
      <Row gap="2">

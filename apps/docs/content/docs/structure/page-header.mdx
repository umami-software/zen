---
title: Page Header
description: "Provides a consistent title and action area for a page."
---

import { Button, Example, Icon, Lucide, PageHeader, PageHeaderActions, PageHeaderTitle, Row, Text } from '../../../mdx-components';
